...
public interface TermMap {
	...
	/**
	 * The constant value of a constant-valued term map is the RDF
	 * term that is the value of its rr:constant property.
	 * Only if CONSTANT_VALUED type.
	 */
	public Value getConstantValue();
	
	/**
	 * The column value of the term map is the data value of that column in a
	 * given logical table row.
	 * Only if COLUMN_VALUED type.
	 */
	 ...
	 * from multiple components. It can reference column names by enclosing 
	 * them in curly braces.
	 * Only if TEMPLATE_VALUED type.
	 */
	 ...
	 * The datatype of these literals can be explicitly specified using
	 * rr:datatype.
	 */
	 ...
	 * If the term map is a column-valued term map, then the implicit
	 * datatype is the corresponding RDF datatype of the respective column
	 * in the logical table row.
	 * Otherwise, the term map must be a template-valued term map and
	 * its implicit datatype is empty
	 */
	public XSDType getImplicitDataType();
	
	/**
	 * A datatype override is in effect on a typeable term map 
	 * if it has a specified datatype, and the specified datatype
	 * is different from its implicit datatype.
	 */
	 ...
	 * column-valued term map or template-value term map. It is represented
	 * by the value of the rr:inverseExpression property.
	 * 
